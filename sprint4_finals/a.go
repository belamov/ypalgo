...
// -- ВРЕМЕННАЯ СЛОЖНОСТЬ --
// итоговая сложность O(N+N*M)~O(N*M), где
...
//    за константу
//  - поисковые запросы выполняются за О(N*M), где M - количество поисковых запросов.
//    каждый отдельный запрос выполняется за О(N) - в худшем случае мы просмотрим все документы - если все слова в запросе содержатся во всех документах
//
