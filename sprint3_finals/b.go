...
// мы используем рекурсивные вызовы одной функции, а каждый вызов функции расходует память на стеке
// в худшем случае, если мы будем выбирать минимальный элемент для каждого отрезка, то вызовов функции
// будет 2N - будем вызывать функцию для пустого отрезка и для оставшегося.
